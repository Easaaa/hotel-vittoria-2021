...
export default function DateRowPicker({
  ...
  const CustomInputArrival = ({ value, onClick }) => (
    <input
      ...
      id='arrival'
      name='arrival'
      className='w-full px-3 py-1 text-base leading-8 text-gray-700 transition-colors duration-200 ease-in-out bg-gray-100 bg-opacity-50 border border-gray-300 rounded outline-none appearance-none focus:border-green-700 focus:bg-white focus:ring-2 focus:ring-indigo-200'
    />
  );
