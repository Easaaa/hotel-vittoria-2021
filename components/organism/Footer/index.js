...
export default function Footer({
  ...
  return (
    <footer className="relative z-50 flex flex-col justify-end w-full pt-10 text-gray-800 bg-bottom bg-gray-50 max-h-800">
      ...
      <div className="grid font-light text-center place-content-center mt-10 bg-black text-gray-100 pb-6">
        <div className="grid mt-6 mb-8  text-sm">
          <p className="leading-normal ">P.iva 01558810980</p>
          <p className="leading-normal ">Codice Regione 017187-ALB-00011</p>
          <p className="leading-normal ">
            Ragione sociale - Hotel Vittoria
          </p>
